    ...
    <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-surface-tertiary border border-border animate-fade-in">
      ...
      >
        ...
        <span className="text-xs text-text-secondary">
          Your <span className="text-text-primary font-medium">Weekly Debrief</span> is ready — see where your energy went this week
        </span>
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-text-tertiary ml-auto shrink-0">
